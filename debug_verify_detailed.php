...
try {
    ...
    if (is_shop_admin()) {
        ...
        if ($shop_status === 'verification_pending') {
            ...
            echo "<p>⚠️ Shop status is not verification_pending: " . $shop_status . "</p>";
        }
        ...
        echo "<p>Testing HTML output...</p>";
        
        // 基本的なHTML出力をテスト
        echo "<div style='border: 1px solid #ccc; padding: 10px; margin: 10px 0;'>";
        echo "<h3>テスト用HTML出力</h3>";
        echo "<p>この部分が表示されれば、HTML出力は正常です。</p>";
        echo "</div>";
