...
CREATE DATABASE IF NOT EXISTS purplelion51_cafejob CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE shops (
    ...
    status ENUM('active', 'inactive', 'pending', 'verification_pending') DEFAULT 'verification_pending',
    verification_code VARCHAR(6),
    verification_sent_at TIMESTAMP NULL,
    verification_verified_at TIMESTAMP NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
