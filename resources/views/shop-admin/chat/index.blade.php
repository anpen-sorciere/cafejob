            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body text-center py-5">
                        ...
                        <a href="{{ route('shop-admin.applications.index') }}" class="btn btn-primary">
                                ...
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="flex-grow-1">
                                        <div class="d-flex align-items-center mb-2">
                                            <h6 class="mb-0 me-2">
                                                {{ $room['last_name'] }} {{ $room['first_name'] }}
                                                <small class="text-muted">({{ $room['user_name'] }})</small>
                                            </h6>
                                    ...
                                    <div class="text-end">
                                        ...
                                        @endif
                                        <a href="{{ route('shop-admin.chat.show.id', ['id' => $room['id']]) }}" class="btn btn-outline-primary btn-sm mt-2">
