...
<div class="container my-8 guide-page">
    ...
    <section class="card p-4 mb-5 guide-section">
        ...
        <p class="text-muted mt-3">
            ※いわゆる「体験入店（体入）」を行わないお店も多くあります。<br>
            その日だけ来てすぐにいなくなる可能性がある人を、バックヤードを含む店内のすべてのエリアに入れることは、<br>
            個人情報保護や防犯の観点からリスクが高いと考える店舗も少なくありません。<br>
            あらかじめ業務委託契約などを結び、何かトラブルが起きたときに責任の所在がはっきりしている状態で<br>
            初回勤務をスタートするスタイルは、キャスト・お店の双方にとって安心な方法のひとつです。
        </p>
    </section>
