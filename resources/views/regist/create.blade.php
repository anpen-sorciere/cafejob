...
<section class="cc-hero-section mb-4">
    <div class="cc-container position-relative" style="z-index: 1;">
        <div class="cc-card text-center">
            ...
            <p class="h5 mb-4">簡単ステップでスピーディに運用開始。</p>
            <a href="#form" class="btn btn-primary btn-lg">
                <i class="fas fa-paper-plane me-2"></i>求人掲載申し込みフォームへ
            </a>
        </div>
    </div>
</section>
...
<!-- 実績セクション -->
<section class="py-5 mb-4" style="background-color: var(--cc-color-bg);">
    <div class="cc-container">
        <div class="cc-card text-center">
            <h2 class="h4 mb-4">貴店を"働きたい子"にもっと届ける場所。</h2>
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="cc-stat-card flex-column text-center">
                        <div class="cc-stat-card-icon mb-2" style="font-size: 32px;">
                            🌟
                        </div>
                        <div class="cc-stat-card-number mb-2">01｜コンカフェのために生まれた求人サイト！</div>
                        <div class="cc-stat-card-label">余計な情報ゼロ、推し店舗がすぐ見つかる専門設計。</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="cc-stat-card flex-column text-center">
                        ...
                        <div class="cc-stat-card-number mb-2">02｜スマホでサクサク！応募まで3タップ</div>
                        <div class="cc-stat-card-label">若い世代が使いやすい"見やすさ"に全振り♪</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="cc-stat-card flex-column text-center">
                        ...
                        <div class="cc-stat-card-number mb-2">03｜コンカフェの"わかってる人"がつくってる！</div>
                        <div class="cc-stat-card-label">現場のリアルを知ってるスタッフがサイトを運営サポート。</div>
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-5 mb-4">
    <div class="cc-container">
        <div class="cc-card">
            <h2 class="h4 mb-4 text-center">カフェコレってどんなサイト？</h2>
            <div class="text-center">
                <p class="h5 mb-3">コンカフェで働きたい子と、<br>新しい仲間を探しているお店をつなぐ<br><strong style="color: var(--cc-color-accent);">コンカフェ特化の求人サイト！</strong></p>
                <p class="mb-0">
                    お店の魅力がもっと伝わるように、<br>
                    業界に合わせた可愛くて使いやすいサイトを目指しています。
                </p>
            </div>
        </div>
    </div>
...
<section class="py-5 mb-4" style="background-color: var(--cc-color-bg);">
    <div class="cc-container">
        <h2 class="h4 mb-4 text-center">カフェコレが選ばれている理由</h2>
        <div class="row g-4">
            <div class="col-md-6">
                <div class="cc-card h-100">
                    <div class="d-flex align-items-start mb-3">
                        <div class="cc-stat-card-icon me-3" style="font-size: 32px;">
                            💗
                        </div>
                        <div>
                            <h3 class="h5 mb-2">【01｜コンカフェ好きが"集まる場所"】</h3>
                            <p class="small mb-0">ここに来る人は、みんなコンカフェに興味津々！<br>貴店の魅力がちゃんと見つけてもらえる場所です。</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="cc-card h-100">
                    <div class="d-flex align-items-start mb-3">
                        ...
                        <div>
                            <h3 class="h5 mb-2">【02｜「働きたい！」が本気の子だけ】</h3>
                            <p class="small mb-0">なんとなく応募、じゃなくて<br>"コンカフェで働きたい！"って気持ちの子が多いから、<br>いい出会いが叶いやすいんです。</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="cc-card h-100">
                    <div class="d-flex align-items-start mb-3">
                        ...
                        <div>
                            <h3 class="h5 mb-2">【03｜お財布に優しいシンプルプラン】</h3>
                            <p class="small mb-0">ムダな費用はぜんぶカット！<br>必要なところだけにしっかり投資できる、<br>やさしい料金設計です。</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="cc-card h-100">
                    <div class="d-flex align-items-start mb-3">
                        ...
                        <div>
                            <h3 class="h5 mb-2">【04｜コンカフェの"わかってる人"がサポート】</h3>
                            <p class="small mb-0">業界の空気感・文化・実情…ぜんぶ知ってるスタッフだから安心！<br>お店の色に合わせてしっかりお手伝いします。</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="cc-container">
        <div class="cc-card">
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="text-center">
                        <div class="cc-stat-card-icon mb-3" style="font-size: 48px; color: var(--cc-color-accent);">
                            <i class="fas fa-hand-point-right"></i>
                        </div>
                        <h3 class="h6 mb-2"><strong>ステップ1：お問い合わせ</strong></h3>
                        <p class="small mb-0">無料資料請求、または掲載相談フォームよりご連絡ください。</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="text-center">
                        ...
                        <h3 class="h6 mb-2"><strong>ステップ2：ヒアリング・プラン提案</strong></h3>
                        <p class="small mb-0">貴店の課題、求めている人材をヒアリングし、最適なプランをご提案します。</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="text-center">
                        ...
                        <h3 class="h6 mb-2"><strong>ステップ3：情報作成・掲載開始</strong></h3>
                        <p class="small mb-0">原稿作成サポートを経て、掲載スタート！</p>
                    </div>
                </div>
            </div>
        </div>
...
<!-- 申し込みフォーム -->
<section id="form" class="py-5 mb-4">
    <div class="cc-container">
        <div class="cc-card">
            ...
            <form method="POST" action="{{ route('regist.store') }}" class="needs-validation" novalidate id="registForm">
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input class="form-check-input @error('no_adult_services') is-invalid @enderror" type="checkbox" id="no_adult_services" name="no_adult_services" value="1" required>
                        <label class="form-check-label" for="no_adult_services">
                            性風俗サービスの提供を行っている等、性風俗に関する営業許可の届け出が必要なサービス、またはそれに準じると判断されるサービスの提供を行っていません。 <span class="text-danger">*</span>
                        </label>
                        @error('no_adult_services')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input class="form-check-input @error('no_illegal_operations') is-invalid @enderror" type="checkbox" id="no_illegal_operations" name="no_illegal_operations" value="1" required>
                        <label class="form-check-label" for="no_illegal_operations">
                            特定異性接客営業等の規制、大阪府青少年健全育成条例、労働基準法、職業安定法、その他各種法律、条例に違反するような営業、求人は行っておりません。 <span class="text-danger">*</span>
                        </label>
                        @error('no_illegal_operations')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                </div>
...
// 初期状態の設定
if (document.getElementById('business_type_corporation') && document.getElementById('business_type_corporation').checked) {
